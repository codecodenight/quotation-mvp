...
export const mirrorLightTemplate: QuoteTemplateConfig = {
  category: "镜前灯",
  ...
  writeHeader: (ws) => writeHeader(ws, mirrorLightTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(mirrorLightTemplate.columns, [
      index + 1,
