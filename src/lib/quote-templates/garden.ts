...
export const gardenTemplate: QuoteTemplateConfig = {
  category: "庭院灯",
  ...
  writeHeader: (ws) => writeHeader(ws, gardenTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(gardenTemplate.columns, [
      index + 1,
