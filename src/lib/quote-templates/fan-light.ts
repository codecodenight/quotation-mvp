...
export const fanLightTemplate: QuoteTemplateConfig = {
  category: "风扇灯",
  sheetName: "LED Fan Light",
  columns: [
  ...
  writeHeader: (ws) => writeHeader(ws, fanLightTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(fanLightTemplate.columns, [
      index + 1,
