...
export const purificationTemplate: QuoteTemplateConfig = {
  category: "净化灯",
  ...
  writeHeader: (ws) => writeHeader(ws, purificationTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(purificationTemplate.columns, [
      index + 1,
