...
export const deskLampTemplate: QuoteTemplateConfig = {
  category: "台灯",
  ...
  writeHeader: (ws) => writeHeader(ws, deskLampTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(deskLampTemplate.columns, [
      index + 1,
