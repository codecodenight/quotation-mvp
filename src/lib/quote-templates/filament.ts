...
export const filamentTemplate: QuoteTemplateConfig = {
  category: "灯丝灯",
  sheetName: "LED Filament Bulb",
  columns: [
    { header: "No.", key: "no", width: 8 },
    { header: "Model No.", key: "modelNo", width: 18 },
    { header: "Power", key: "power", width: 12 },
    { header: "Base", key: "base", width: 12 },
    { header: "LED Type", key: "ledType", width: 14 },
  ...
  writeHeader: (ws) => writeHeader(ws, filamentTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(filamentTemplate.columns, [
      index + 1,
