...
export const wallLampTemplate: QuoteTemplateConfig = {
  category: "壁灯",
  ...
  writeHeader: (ws) => writeHeader(ws, wallLampTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(wallLampTemplate.columns, [
      index + 1,
