...
export const cabinetTemplate: QuoteTemplateConfig = {
  category: "橱柜灯",
  ...
  writeHeader: (ws) => writeHeader(ws, cabinetTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(cabinetTemplate.columns, [
      index + 1,
