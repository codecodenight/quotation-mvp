...
export const emergencyTemplate: QuoteTemplateConfig = {
  category: "应急灯",
  ...
  writeHeader: (ws) => writeHeader(ws, emergencyTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(emergencyTemplate.columns, [
      index + 1,
