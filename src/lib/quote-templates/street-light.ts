...
export const streetLightTemplate: QuoteTemplateConfig = {
  category: "路灯",
  ...
  writeHeader: (ws) => writeHeader(ws, streetLightTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(streetLightTemplate.columns, [
      index + 1,
