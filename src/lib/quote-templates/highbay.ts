...
export const highbayTemplate: QuoteTemplateConfig = {
  category: "Highbay",
  ...
  writeHeader: (ws) => writeHeader(ws, highbayTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(highbayTemplate.columns, [
      index + 1,
