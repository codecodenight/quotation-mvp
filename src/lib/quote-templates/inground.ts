...
export const ingroundTemplate: QuoteTemplateConfig = {
  category: "地埋灯/地插灯",
  ...
  writeHeader: (ws) => writeHeader(ws, ingroundTemplate),
  buildRowCells: (item, index) => buildRowCellsFromValues(ingroundTemplate.columns, [
      index + 1,
