...
export const g4g9Template: QuoteTemplateConfig = {
  category: "G4G9",
  ...
  writeHeader: (ws) => writeHeader(ws, g4g9Template),
  buildRowCells: (item, index) => buildRowCellsFromValues(g4g9Template.columns, [
      index + 1,
